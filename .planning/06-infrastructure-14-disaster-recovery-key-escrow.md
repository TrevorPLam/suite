...
| **Key escrow (zero‑knowledge)** | Shamir secret sharing + AES‑256‑GCM | Users can recover their account key without the server ever holding the plaintext key. The system stores encrypted key shares; the user holds a recovery code printed at account creation. |
...
**[End of Section 15 — Next: Section 16: Monetization & Free‑Tier Limits]**